			...
			<div class="row">
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="/" class="menu-link active">
							<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								{!! getSvgIcon('duotune/general/gen025.svg', 'svg-icon svg-icon-primary svg-icon-1') !!}
							</span>
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="#" class="menu-link">
							<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								{!! getSvgIcon('duotune/ecommerce/ecm002.svg', 'svg-icon svg-icon-danger svg-icon-1') !!}
							</span>
							<span class="d-flex flex-column">
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="#" class="menu-link">
							<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								{!! getSvgIcon('duotune/abstract/abs045.svg', 'svg-icon svg-icon-info svg-icon-1') !!}
							</span>
							<span class="d-flex flex-column">
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="#" class="menu-link">
							<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								{!! getSvgIcon('duotune/art/art002.svg', 'svg-icon svg-icon-success svg-icon-1') !!}
							</span>
							<span class="d-flex flex-column">
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="#" class="menu-link">
							<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								{!! getSvgIcon('duotune/graphs/gra001.svg', 'svg-icon svg-icon-dark svg-icon-1') !!}
							</span>
							<span class="d-flex flex-column">
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="#" class="menu-link">
							<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								{!! getSvgIcon('duotune/general/gen019.svg', 'svg-icon svg-icon-warning svg-icon-1') !!}
							</span>
							<span class="d-flex flex-column">
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="#" class="menu-link">
							<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								{!! getSvgIcon('duotune/abstract/abs043.svg', 'svg-icon svg-icon-danger svg-icon-1') !!}
							</span>
							<span class="d-flex flex-column">
				...
				<div class="col-lg-6 mb-3">
					...
					<div class="menu-item p-0 m-0">
						...
						<a href="#" class="menu-link">
							<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
								{!! getSvgIcon('duotune/communication/com004.svg', 'svg-icon svg-icon-primary svg-icon-1') !!}
							</span>
							<span class="d-flex flex-column">
